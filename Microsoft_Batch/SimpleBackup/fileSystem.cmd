...
REM Param_1: Path to backupFolder
REM Param_2: Folder to validate as valid backup.
...
REM Calculate the length of the folder to be validated.
SET "varResultStrLength2=NOT_DEFINED"
...
IF "%varCheckIfFileOrFolderExistResult%"=="NO" IF "%~5"=="EXCEPTION_YES" (
    CALL  ..\utility_functions :Exception_End "NO_FILE_HANDLE" ":checkIfFileOrFolderExist - Path in variable %~2 not found. Exit" "OUTPUT_TO_STDOUT" ""
)
